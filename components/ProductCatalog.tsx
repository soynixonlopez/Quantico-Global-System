          ...
          {products.map((product, i) => (
            ...
            >
              ...
              <div className="p-4 sm:p-5">
                ...
                <p className="text-muted-foreground text-xs sm:text-sm mt-2 line-clamp-2">{product.description}</p>
                <div className="mt-3 sm:mt-4 flex flex-wrap items-center justify-between gap-2">
                  <span className="text-primary font-medium text-sm sm:text-base">{product.price}</span>
                  <a
                    href="https://wa.me/50760707201"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm text-primary hover:opacity-80 font-medium py-1 -mr-1"
                  >
                    Cotizar →
                  </a>
                </div>
